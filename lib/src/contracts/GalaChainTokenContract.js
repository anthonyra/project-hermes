...
const nodeOperations_1 = require("src/chaincode/nodeOperations");
...
let GalaChainTokenContract = class GalaChainTokenContract extends chaincode_1.GalaContract {
    ...
    CreateTokenClass(ctx, dto) {
        ...
        return (0, chaincode_1.createTokenClass)(ctx, {
            network: (_a = dto.network) !== null && _a !== void 0 ? _a : chain_api_1.CreateTokenClassDto.DEFAULT_NETWORK,
            tokenClass: dto.tokenClass,
            isNonFungible: !!dto.isNonFungible,
            decimals: (_b = dto.decimals) !== null && _b !== void 0 ? _b : chain_api_1.CreateTokenClassDto.DEFAULT_DECIMALS,
            name: dto.name,
            symbol: dto.symbol,
            ...
            maxSupply: (_c = dto.maxSupply) !== null && _c !== void 0 ? _c : chain_api_1.CreateTokenClassDto.DEFAULT_MAX_SUPPLY,
            maxCapacity: (_d = dto.maxCapacity) !== null && _d !== void 0 ? _d : chain_api_1.CreateTokenClassDto.DEFAULT_MAX_CAPACITY,
            totalMintAllowance: (_e = dto.totalMintAllowance) !== null && _e !== void 0 ? _e : chain_api_1.CreateTokenClassDto.INITIAL_MINT_ALLOWANCE,
            totalSupply: (_f = dto.totalSupply) !== null && _f !== void 0 ? _f : chain_api_1.CreateTokenClassDto.INITIAL_TOTAL_SUPPLY,
            totalBurned: (_g = dto.totalBurned) !== null && _g !== void 0 ? _g : chain_api_1.CreateTokenClassDto.INITIAL_TOTAL_BURNED,
    ...
    GrantAllowance(ctx, dto) {
        ...
        return (0, chaincode_1.grantAllowance)(ctx, {
            ...
            uses: dto.uses,
            expires: (_a = dto.expires) !== null && _a !== void 0 ? _a : chain_api_1.GrantAllowanceDto.DEFAULT_EXPIRES
        });
    }
    ...
    FullAllowanceCheck(ctx, dto) {
        ...
        return (0, chaincode_1.fullAllowanceCheck)(ctx, {
            ...
            allowanceType: (_c = dto.allowanceType) !== null && _c !== void 0 ? _c : chain_api_1.AllowanceType.Use,
    ...
    FetchAllowances(ctx, dto) {
        ...
        return (0, chaincode_1.fetchAllowancesWithPagination)(ctx, {
            ...dto,
            limit: (_a = dto.limit) !== null && _a !== void 0 ? _a : chain_api_1.FetchAllowancesDto.DEFAULT_LIMIT
        });
    }
     ...
     */
    async HighThroughputMint(ctx, dto) {
    ...
    async FetchMintRequests(ctx, dto) {
        const mintRequestsClassKey = (0, class_transformer_1.plainToClass)(chain_api_1.TokenClassKey, {
            collection: dto.collection,
            category: dto.category,
            type: dto.type,
            additionalKey: dto.additionalKey
    ...
    async MintToken(ctx, dto) {
        ...
        return (0, chaincode_1.mintToken)(ctx, {
            ...
            authorizedBridgeUser: undefined,
    ...
    LockTokens(ctx, dto) {
        var _a, _b;
        // const verifyAuthorizedBridgeUser = (c: TokenClassKey) => bridgeTypeUser(ctx, dto.lockAuthority, c);
    ...
    SignNodeAgreement(dto) {
        const { tokenInstanceKey, nodePublicKey, operatorAgreement } = dto;
        return (0, nodeOperations_1.signNodeAgreement)({ tokenInstanceKey, nodePublicKey, operatorAgreement });
    }
    ActivateNode(ctx, dto) {
        var _a;
        return (0, nodeOperations_1.activateNode)(ctx, {
            owner: (_a = dto.owner) !== null && _a !== void 0 ? _a : ctx.callingUser,
            lockAuthority: dto.lockAuthority,
    ...
    DeactivateNode(ctx, dto) {
        var _a;
        return (0, nodeOperations_1.deactivateNode)(ctx, {
            owner: (_a = dto.owner) !== null && _a !== void 0 ? _a : ctx.callingUser,
            tokenInstanceKey: dto.tokenInstanceKey
        });
    }
    UpdateNode(ctx, dto) {
        var _a;
        return (0, nodeOperations_1.updateNode)(ctx, {
            owner: (_a = dto.owner) !== null && _a !== void 0 ? _a : ctx.callingUser,
            tokenInstanceKey: dto.tokenInstanceKey,
            nodePublicKey: dto.nodePublicKey,
            operatorAgreement: dto.operatorAgreement
    ...
    FetchNodeMetadata(ctx, dto) {
        return (0, nodeOperations_1.fetchNodeMetadata)(ctx, dto);
    }
};
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.CreateTokenClassDto,
        out: chain_api_1.TokenClassKey,
        allowedOrgs: ["CuratorOrg"],
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.CreateTokenClassDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "CreateTokenClass", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.UpdateTokenClassDto,
        out: chain_api_1.TokenClassKey,
        allowedOrgs: ["CuratorOrg"],
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.UpdateTokenClassDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "UpdateTokenClass", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.EVALUATE,
        in: chain_api_1.FetchTokenClassesDto,
        out: { arrayOf: chain_api_1.TokenClass }
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.FetchTokenClassesDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "FetchTokenClasses", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.EVALUATE,
        in: chain_api_1.FetchTokenClassesWithPaginationDto,
        out: chain_api_1.FetchTokenClassesResponse
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.FetchTokenClassesWithPaginationDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "FetchTokenClassesWithPagination", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.GrantAllowanceDto,
        out: { arrayOf: chain_api_1.TokenAllowance },
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.GrantAllowanceDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "GrantAllowance", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.RefreshAllowancesDto,
        out: { arrayOf: chain_api_1.TokenAllowance },
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.RefreshAllowancesDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "RefreshAllowances", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.EVALUATE,
        in: chain_api_1.FullAllowanceCheckDto,
        out: chain_api_1.FullAllowanceCheckResDto
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.FullAllowanceCheckDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "FullAllowanceCheck", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.EVALUATE,
        in: chain_api_1.FetchAllowancesDto,
        out: chain_api_1.FetchAllowancesResponse
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.FetchAllowancesDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "FetchAllowances", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.DeleteAllowancesDto,
        out: "number",
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.DeleteAllowancesDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "DeleteAllowances", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.EVALUATE,
        in: chain_api_1.FetchBalancesDto,
        out: { arrayOf: chain_api_1.TokenBalance }
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.FetchBalancesDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "FetchBalances", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.HighThroughputMintTokenDto,
        out: chain_api_1.FulfillMintDto,
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.HighThroughputMintTokenDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "RequestMint", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.FulfillMintDto,
        out: { arrayOf: chain_api_1.TokenInstanceKey },
        allowedOrgs: ["CuratorOrg"]
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.FulfillMintDto]),
    tslib_1.__metadata("design:returntype", Promise)
        ...
        sequence: [
            {
                ...
                isWrite: true,
                dtoSchema: (0, chain_api_1.generateSchema)(chain_api_1.HighThroughputMintTokenDto),
                responseSchema: (0, chain_api_1.generateResponseSchema)(chain_api_1.FulfillMintDto)
            },
            {
                methodName: "FulfillMint",
                isWrite: true,
                dtoSchema: (0, chain_api_1.generateSchema)(chain_api_1.FulfillMintDto),
                responseSchema: (0, chain_api_1.generateResponseSchema)(chain_api_1.TokenInstanceKey, "array")
            }
        ]
    }),
    tslib_1.__metadata("design:type", Function),
...
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.EVALUATE,
        in: chain_api_1.FetchMintRequestsDto,
        out: { arrayOf: chain_api_1.MintRequestDto }
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.FetchMintRequestsDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "FetchMintRequests", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.MintTokenDto,
        out: { arrayOf: chain_api_1.TokenInstanceKey },
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.MintTokenDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "MintToken", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.MintTokenWithAllowanceDto,
        out: { arrayOf: chain_api_1.TokenInstanceKey },
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.MintTokenWithAllowanceDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "MintTokenWithAllowance", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.BatchMintTokenDto,
        out: { arrayOf: chain_api_1.TokenInstanceKey },
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.BatchMintTokenDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "BatchMintToken", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.UseTokenDto,
        out: chain_api_1.TokenBalance,
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, chain_api_1.UseTokenDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "UseToken", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.ReleaseTokenDto,
        out: chain_api_1.TokenBalance,
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, chain_api_1.ReleaseTokenDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "ReleaseToken", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.LockTokenDto,
        out: chain_api_1.TokenBalance,
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, chain_api_1.LockTokenDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "LockToken", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.LockTokensDto,
        out: { arrayOf: chain_api_1.TokenBalance },
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, chain_api_1.LockTokensDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "LockTokens", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.UnlockTokenDto,
        out: chain_api_1.TokenBalance,
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.UnlockTokenDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "UnlockToken", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.UnlockTokensDto,
        out: { arrayOf: chain_api_1.TokenBalance },
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.UnlockTokensDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "UnlockTokens", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.TransferTokenDto,
        out: { arrayOf: chain_api_1.TokenBalance },
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext,
        chain_api_1.TransferTokenDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "TransferToken", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: chain_api_1.BurnTokensDto,
        out: { arrayOf: chain_api_1.TokenBurn },
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, chain_api_1.BurnTokensDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "BurnTokens", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.EVALUATE,
        in: chain_api_1.FetchBurnsDto,
        out: { arrayOf: chain_api_1.TokenBurn }
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, chain_api_1.FetchBurnsDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "FetchBurns", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.EVALUATE,
        in: nodes_1.SignNodeAgreementDto,
        out: NodeOperatorAgreement_1.NodeOperatorMetadata
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [nodes_1.SignNodeAgreementDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "SignNodeAgreement", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: nodes_1.ActivateNodeDto,
        out: nodes_1.ActivateNodeResponse,
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, nodes_1.ActivateNodeDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "ActivateNode", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: nodes_1.DeactivateNodeDto,
        out: NodeOperatorAgreement_1.NodeMetadata,
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, nodes_1.DeactivateNodeDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "DeactivateNode", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.SUBMIT,
        in: nodes_1.UpdateNodeDto,
        out: NodeOperatorAgreement_1.NodeMetadata,
        verifySignature: true
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, nodes_1.UpdateNodeDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "UpdateNode", null);
tslib_1.__decorate([
    (0, chaincode_1.GalaTransaction)({
        type: chaincode_1.EVALUATE,
        in: nodes_1.FetchNodeMetadataDto,
        out: NodeOperatorAgreement_1.NodeMetadata
    }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [chaincode_1.GalaChainContext, nodes_1.FetchNodeMetadataDto]),
    tslib_1.__metadata("design:returntype", Promise)
], GalaChainTokenContract.prototype, "FetchNodeMetadata", null);
